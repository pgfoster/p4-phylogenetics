...
if True:
    ...
    def newComp(self, partNum=0, free=0, spec='empirical', val=None, symbol=None):
        ...
        # Ziheng!
            ...
            mt.val = [0.0780477, 0.0551072, 0.0383762, 0.0400644,
                      0.0104294, 0.0381555, 0.0525101, 0.0809269,
                      0.0219102, 0.0737598, 0.1023120, 0.0504864,
                      0.0228575, 0.0533891, 0.0456078, 0.0561981,
                      0.0581606, 0.0178197, 0.0316828, 0.0721985]
            theSum = sum(mt.val)
            for i in range(len(mt.val)):
                mt.val[i] /= theSum
        elif spec == 'gnetREV':
            mt.val = [0.0804159, 0.0564102, 0.0341881, 0.0529091,
                      0.0163156, 0.0371244, 0.0695518, 0.0659491,
                      0.0241053, 0.0548567, 0.1030550, 0.0607388,
                      0.0221149, 0.0411563, 0.0467422, 0.0691408,
                      0.0475138, 0.0161454, 0.0308965, 0.0706698]
            theSum = sum(mt.val)
            for i in range(len(mt.val)):
                mt.val[i] /= theSum
