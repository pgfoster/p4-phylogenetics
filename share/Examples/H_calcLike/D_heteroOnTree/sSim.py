...
t.setModelComponentOnNode(c2, node=3, clade=1)
...
t.setModelComponentOnNode(r1, node=2, clade=1)
t.setModelComponentOnNode(r2, node=1, clade=1)
t.setModelComponentOnNode(r2, node=7, clade=1)
